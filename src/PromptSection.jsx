...
import { faForward , faShare , faCaretRight  } from "@fortawesome/free-solid-svg-icons";
...
function PromptSection() {
  ...
  return (
    <>
      {/* prompt section */}
      <div className="bg-secondary-medium d-flex  justify-content-center
         align-self-center " style={{ height: "20vh" }}>
        <div
        ...
        >
          ...
          >
            <input
              style={{ width: "90%",outline:"none",border:"white",backgroundColor:"rgb(56, 55, 55)"
              ,color:"white",borderTopLeftRadius:'8px',borderBottomLeftRadius:'8px'
              }}
              type="text"
            ...
            className=" " style={{width:"10%",height:"100%",color:"green",
            backgroundColor:"rgb(56, 55, 55)" , borderTopRightRadius:'8px' ,
             borderBottomRightRadius:'8px',
            cursor:"pointer"
             }} />
            {/* <i  className="fa-duotone fa-forward bg-light " style={{width:"10%"}}></i> */}
